                          ...
                          >
                            ...
                            <div>
                              <div className='h-10 absolute right-0'>
                                ...
                                {
                                  loginStatus === false ?
                                      <p className='flex items-center ml-2 cursor-pointer text-[var(--bgcolor-navbar-click)] text-lg' onClick={handleCannot}>
                                      ...
                                      <p className='flex items-center ml-2 cursor-pointer text-[var(--bgcolor-navbar-click)] text-base' onClick={handleLike}>
                                        {
