                          ...
                          >
                            ...
                            <div>
                              <div className='h-10 absolute right-0'>
                                <div className='ml-3 text-[var(--bgcolor-navbar-click)] text-base flex items-center'>
                                  <p style={{ userSelect: 'none' }}>文章还不错？给作者一个赞~😉</p>
                                {
                                  loginStatus === false ?
                                      <p className='flex items-center ml-2 cursor-pointer text-[var(--bgcolor-navbar-click)] text-lg' onClick={handleCannot} style={{ userSelect: 'none' }}>
