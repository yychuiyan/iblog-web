                          ...
                          >
                            <div className='flex lg:flex-wrap' style={{ userSelect: 'none' }}>
                              <p className="flex lg:pl-5">
                                <IconFont iconName='icon-biaoqian' className='text-[28px] pr-1'></IconFont>
                                {item.tags.map((it) => (
                                  <span
                ...
                <div className="w-auto  bg-base-100 rounded-3xl">
                  ...
                  >
                    <p className="flex items-center h-10 text-xl  px-3">
                      <svg className="icon w-7 h-7 pr-1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="67666"><path d="M655.36 678.4m-288 0a288 288 0 1 0 576 0 288 288 0 1 0-576 0Z" fill="#FFD84A" p-id="67667"></path><path d="M631.04 915.2h-358.4c-120.32 0-217.6-97.28-217.6-217.6v-448c0-120.32 97.28-217.6 217.6-217.6h358.4c120.32 0 217.6 97.28 217.6 217.6v448c0 120.32-98.56 217.6-217.6 217.6z m-358.4-832c-92.16 0-166.4 74.24-166.4 166.4v448c0 92.16 74.24 166.4 166.4 166.4h358.4c92.16 0 166.4-74.24 166.4-166.4v-448c0-92.16-74.24-166.4-166.4-166.4h-358.4z" fill='var(--color-icon-default)' p-id="67668"></path><path d="M547.84 348.16h-192c-14.08 0-25.6-11.52-25.6-25.6s11.52-25.6 25.6-25.6h192c14.08 0 25.6 11.52 25.6 25.6s-11.52 25.6-25.6 25.6zM547.84 499.2h-192c-14.08 0-25.6-11.52-25.6-25.6s11.52-25.6 25.6-25.6h192c14.08 0 25.6 11.52 25.6 25.6s-11.52 25.6-25.6 25.6z" fill='var(--color-icon-default)' p-id="67669"></path></svg>
                      目录
                    </p>
                  </div>
                  {/* 目录信息 */}
